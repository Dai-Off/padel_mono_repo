      ...
      <View style={styles.playerSlot}>
        ...
        >
          <Text
            style={
              isPrivate
                ? styles.playerAvatarFreeDash
                : styles.playerAvatarFreePlus
            }
          >
            {isPrivate ? "—" : "+"}
          </Text>
    ...
    >
          ...
          <View
            style={[
              ...
              item.mode === "competitivo"
                ? styles.cardBadgeCompetitivo
                : styles.cardBadgeAmistoso,
              d &&
                (item.mode === "competitivo"
      ...
      <View style={[styles.venueRow, d && styles.venueRowDark]}>
        ...
        <View style={styles.venueBody}>
          <Text
            style={[styles.venueName, d && styles.venueNameDark]}
            numberOfLines={1}
          >
            {item.venue}
          </Text>
...
const styles = StyleSheet.create({
  ...
  cardLevelRange: { fontSize: 10, color: "#6b7280", minWidth: "20%" },
  privateReservadoRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,

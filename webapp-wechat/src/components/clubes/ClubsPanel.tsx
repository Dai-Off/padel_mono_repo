...
import { ClubRowActions } from './ClubRowActions';
...
/** Listado de clubes activos (pestaña "Clubes" dentro de la página Clubes). */
        ...
        <>
            ...
            >
                <table className="w-full table-fixed text-left text-sm">
                    ...
                    <tbody>
                        {pageClubs.map((club) => (
                            <tr key={club.id} className="h-11 border-b border-auth-border/60 last:border-0">

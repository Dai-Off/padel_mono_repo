...
**Autenticación:** salvo que se indique _público_, las rutas suelen aceptar `Authorization: Bearer <access_token>` de Supabase Auth. Algunas exigen **dueño de club / admin** (`requireClubOwnerOrAdmin` o `requireAdmin`).
